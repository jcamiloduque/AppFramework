...
class Translator{
    ...
    static public function translate($value, $lang=null,$save=true){
		...
		if(Configuration::value("adminted_languages")!==null)$lang=in_array($lang,Configuration::value("adminted_languages"))?$lang:Configuration::value("language");
		if($lang==Configuration::value("language"))return $value;
        $path=APP_PATH."/translate/".Configuration::value("language")."2".$lang.".txt";
		...
		$data = self::staticTranslate($value,Configuration::value("language"),$lang);
