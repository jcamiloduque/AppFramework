...
class app_library_captcha {
    ...
    public $session_var = 'app_library_captcha';
    ...
    public $shadowColor = null; //array(50, 50, 50);
    /**
     * Font configuration
     *
     * - font: TTF file
    ...
    public function CreateImage() {
        ...
        $_SESSION[$this->session_var] = str_replace("   "," ",$text);
        /** Transformations */
        $this->WaveImage();
    ...
    protected function WriteText($text, $fontcfg = array()) {
        ...
        $fontSizefactor = 1+($lettersMissing*0.009);
    ...
    protected function WriteImage() {
		...
		$return ="data:image/png;base64,".(string)$return;
		return $return;
    }
}
